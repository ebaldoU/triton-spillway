...
def main() -> None:
    ...
    parser.add_argument("--json-out", default=None,
                        help="Si se indica, vuelca los resultados a este fichero JSON")
    ...
    casos.append({"query": "Q1  20 pasos × mapa completo  [H,QX,QY,MH]", "tiempos_s": t,
                  "media_s": float(sum(t) / len(t)), "bytes": nb})
    ...
    casos.append({"query": "Q2  20 pasos × mapa completo  [H]", "tiempos_s": t,
                  "media_s": float(sum(t) / len(t)), "bytes": nb})
    ...
    casos.append({"query": "Q3  1 paso (10_00) × mapa completo  [H,QX,QY,MH]", "tiempos_s": t,
                  "media_s": float(sum(t) / len(t)), "bytes": nb})
    ...
    casos.append({"query": "Q4  20 pasos × región 5k×5k  [H,QX,QY,MH]", "tiempos_s": t,
                  "media_s": float(sum(t) / len(t)), "bytes": nb})
    ...
    casos.append({"query": "Q5  1 paso (10_00) × región 5k×5k  [H,QX,QY,MH]", "tiempos_s": t,
                  "media_s": float(sum(t) / len(t)), "bytes": nb})
    ...
    if args.json_out:
        ...
        from bench_meta import machine_metadata
        payload = {"tipo": "queries", "dataset": args.dataset,
                   "casos": casos, "maquina": machine_metadata()}
