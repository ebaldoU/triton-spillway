...
\bottomrule
\end{tabularx}
\caption{Resumen de validación funcional. Todas las discrepancias son nulas o de orden $10^{-5}$ atribuibles a aritmética de punto flotante.}
...
\begin{axis}[
  ...
  symbolic x coords={datos3,datos8,datos1},
  xtick=data,
  xticklabels={
    {datos3\\[-1pt]{\footnotesize(498\,M celdas, seco)}},
    {datos8\\[-1pt]{\footnotesize(1\,281\,M celdas)}},
    {datos1\\[-1pt]{\footnotesize(1\,287\,M celdas)}}
  },
  ...
  legend style={
    ...
    rounded corners=2pt, row sep=2pt
  },
  tick label style={font=\small},
  nodes near coords,
  nodes near coords style={font=\small\bfseries, anchor=south, inner sep=3pt},
]

\addplot[fill=blue!40, draw=blue!75!black, line width=0.8pt]
    coordinates {(datos3,15.4) (datos8,27.0) (datos1,28.1)};
\addlegendentry{Q5 — Evolución de extensión (multi-paso, 20 fragmentos)}

\addplot[fill=red!40, draw=red!75!black, line width=0.8pt]
    coordinates {(datos3,25.9) (datos8,59.3) (datos1,70.3)};
\addlegendentry{Q7 — Hora de llegada del frente (acumulada por píxel)}

\end{axis}
\end{tikzpicture}
\caption{Tiempo de consulta (caché caliente, dominio completo) en tres escenarios de distinto volumen de inundación. El salto principal se produce entre el escenario seco (datos3, 498\,M celdas) y los escenarios húmedos (datos8 y datos1, $\sim$1\,280\,M): Q7 tarda 2,3$\times$ más y Q5 un 1,8$\times$ más. La diferencia entre datos8 y datos1 es pequeña porque tienen una extensión de inundación casi idéntica. Q4 (mapa inundado, instantánea) responde en menos de 1,5 s en los tres casos y se omite de la gráfica por su diferente escala.}
