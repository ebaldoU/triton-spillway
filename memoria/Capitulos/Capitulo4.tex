...
\begin{axis}[
  ...
  legend style={
    ...
    rounded corners=2pt, column sep=8pt
  },
  tick label style={font=\small},
  nodes near coords,
  nodes near coords style={font=\scriptsize, anchor=south, inner sep=2pt, rotate=90, xshift=6pt},
]
...
\addlegendentry{Q7 — Hora de llegada del frente (acumulada)}

\end{axis}
\end{tikzpicture}
\caption{Tiempo de consulta (caché caliente, dominio completo) en cuatro escenarios con distinto número de celdas húmedas. Q4 (instantánea, un único fragmento) escala de forma casi plana ($<$1,5 s en todos los casos). Q5 y Q7 crecen aproximadamente de forma lineal con el volumen: al pasar de 334\,M (datos7) a 1\,392\,M celdas (datos6), Q5 se multiplica por 4,4$\times$ y Q7 por 4,2$\times$.}
\label{fig:escalabilidad}
\end{figure}

Al cuadruplicar aproximadamente el volumen (de 334\,M a 1\,392\,M celdas, factor 4,2$\times$), Q5 pasa de 6,2 a 27,0 s (4,4$\times$) y Q7 de 16,7 a 69,5 s (4,2$\times$), confirmando la escalabilidad aproximadamente lineal. Q4, al acceder a un único fragmento, apenas varía (0,4 a 1,4 s, factor 3,5$\times$, con mayor peso del coste fijo de apertura del array). La pendiente algo más pronunciada de Q7 respecto a Q5 se debe al \textit{grid} acumulador de tamaño fijo $n_r \times n_c$ que recibe escrituras dispersas en los 20 fragmentos: cuantas más celdas húmedas por fragmento, mayor presión de caché en las actualizaciones.
