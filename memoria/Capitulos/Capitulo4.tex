...
Este capítulo verifica que el sistema desarrollado produce resultados correctos y cuantifica su rendimiento en términos de latencia y consumo de recursos. La validación se estructura en dos partes: comprobación de la integridad y exactitud de las consultas (11 consultas y el proceso ETL, con más de 4\,500 comparaciones en total), y evaluación del rendimiento de las principales funciones del motor analítico.
...
\textbf{Q2 (calado máximo en punto).} Para 50 puntos aleatorios en datos1, el calado máximo devuelto por el motor se contrasta con el máximo de las 20 lecturas directas del GeoTIFF de H en la celda correspondiente. Discrepancias: 0 de 50 comparaciones.
...
\textbf{Q5 y Q12 (evolución de extensión e inundación por hora).} Ambas funciones calculan, para cada uno de los 20 pasos temporales, el número de celdas con $H \geq 0{,}01$ m. El recuento devuelto por el motor sobre los 20 pasos de datos1 y datos3 se contrasta contra el recuento directo de píxeles en los GeoTIFF de H. Diferencias: inferiores a 1 celda en todos los pasos (truncamiento entero). Discrepancias significativas: 0 de 40 comparaciones.
...
Para las consultas que aplican criterios de clasificación derivados de normativa o bibliografía (Q10a/b, Q15, Q16), la estrategia de oráculo cambia: en lugar de comparar contra GeoTIFF, se construye una cuadrícula sintética con valores de H y $Q_{mod}$ conocidos que cubren explícitamente todos los casos de la tabla de decisión. El resultado del motor se contrasta contra la clasificación manual.

\textbf{Q10a y Q10b (peligrosidad Russo).} Se construye una cuadrícula de $4\times4$ celdas con combinaciones de ($H$, $Q_{mod}$) que cruzan los dos umbrales de Q10a ($H > 0{,}50$ m o $Q_{mod} > 0{,}50$ m²/s) y los dos de Q10b ($H > 0{,}25$ m o $Q_{mod} > 0{,}15$ m²/s). Las 16 celdas de Q10a y las 16 de Q10b se clasifican correctamente según la máscara booleana implementada. Discrepancias: 0 de 32 comparaciones.

\textbf{Q15 (semáforo de calado).} La función \texttt{russo\_traffic\_light\_counts} se aplica a un array de 12 celdas con valores distribuidos uniformemente entre los tres rangos ($H_{WET} \leq H \leq 0{,}25$ m, $0{,}25 < H \leq 0{,}50$ m, $H > 0{,}50$ m). Los recuentos devueltos coinciden con el conteo manual. Discrepancias: 0.

\textbf{Q16 (zona de graves daños, RD 9/2008).} El criterio normativo es $H > 1$ m \textbf{o} $V > 1$ m/s \textbf{o} $H \cdot V > 0{,}5$ m²/s. Se construye una cuadrícula de $3\times3$ celdas que activa cada criterio por separado y en combinación: (1) $H = 1{,}2$ m, $V = 0{,}3$ m/s; (2) $H = 0{,}3$ m, $V = 1{,}5$ m/s; (3) $H = 0{,}4$ m, $V = 1{,}4$ m/s ($H \cdot V = 0{,}56$); y seis casos bajo el umbral conjunto. La función \texttt{graves\_danos\_mask} clasifica correctamente las 9 celdas. Discrepancias: 0.
...
\midrule
\multicolumn{4}{l}{\textit{GeoTIFF como referencia}} \\[2pt]
Q1 — Calado en punto & Lectura directa GeoTIFF & 250 & 0 \\
Q2 — Calado máximo en punto & Máximo por paso GeoTIFF & 50 & 0 \\
Q3 — Velocidad en zona & Cálculo vectorial GeoTIFF & 4 & 0 \\
Q4 — Mapa inundado & Recuento píxeles GeoTIFF & 16 & 0 \\
Q5/Q12 — Extensión por hora & Recuento píxeles GeoTIFF & 40 & 0 \\
Q7 — Hora de llegada & Inspección secuencia GeoTIFF & 20 & 0 \\
Q13 — Volumen por hora & Suma directa GeoTIFF & 80 & 0 \\[4pt]
\multicolumn{4}{l}{\textit{Cuadrícula sintética (verificación de umbrales normativos)}} \\[2pt]
Q10a/b — Peligrosidad Russo & Clasificación manual & 32 & 0 \\
Q15 — Semáforo de calado & Clasificación manual & 12 & 0 \\
Q16 — Zona graves daños (RD 9/2008) & Clasificación manual & 9 & 0 \\[4pt]
