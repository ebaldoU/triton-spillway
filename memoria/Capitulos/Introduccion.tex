...
Los capítulos~\ref{descripcion-de-los-datos} a~\ref{tecnologia-tiledb} describen los datos, las tecnologías evaluadas y TileDB; el capítulo~\ref{diseno-del-sistema} presenta el diseño del sistema y el proceso ETL; los capítulos~\ref{benchmark-de-almacenamiento} a~\ref{validacion-del-sistema} recogen el \textit{benchmark} de almacenamiento, las herramientas desarrolladas y la validación; y el capítulo~\ref{conclusiones-y-trabajo-futuro} las conclusiones. Los Anexos A--E completan la memoria con el catálogo de consultas, las tablas detalladas del \textit{benchmark}, el contexto hidráulico, el proceso ETL detallado y la guía de despliegue.
