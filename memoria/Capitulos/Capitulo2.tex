...
TileDB no requiere servidor: los arrays se almacenan directamente en el sistema de ficheros (o en la nube) como directorios con metadatos, fragmentos de datos y ficheros de índice, y el acceso se realiza mediante la biblioteca Python (o C/C++/R) sin ningún servicio en ejecución.
...
Se utilizó el filtro ByteShuffle+ZSTD nivel 9 \cite{tiledb_compression_tutorial, tiledb_compression, tiledb_docs_compression}, seleccionado mediante el \textit{benchmark} de 15 configuraciones del capítulo~\ref{benchmark-de-almacenamiento}: ByteShuffle reordena los bytes de los float32 agrupando exponentes y mantisas similares antes de comprimir, lo que reduce el almacenamiento un 8,9 \% adicional respecto a ZSTD-1 sin penalización apreciable en lectura.
