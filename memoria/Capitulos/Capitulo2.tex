...
Este capítulo describe el funcionamiento interno de TileDB con el objetivo de justificar las decisiones de diseño adoptadas en el capítulo siguiente: las secciones~\ref{que-es-tiledb} y~\ref{arrays-sparse-vs.-densos} presentan la tecnología y su modelo de datos sparse, la sección~\ref{fragmentos-y-consolidacion} la gestión de fragmentos y la sección~\ref{compresion} el mecanismo de compresión.
