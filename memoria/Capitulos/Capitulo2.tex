...
La configuración final ahorra un 8,9\,\% de espacio con tiempos de lectura equivalentes y un incremento mínimo del tiempo de carga, asumible al ser la ingesta un proceso puntual. Las herramientas construidas sobre ella se describen en los capítulos~\ref{herramientas-desarrolladas} y~\ref{validacion-del-sistema}.
