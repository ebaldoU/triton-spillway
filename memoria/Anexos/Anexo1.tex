...
Para vehículos, la velocidad crítica de arrastre $U_{c,v}(H)$ se obtiene de Xia et al.\ \cite{xia2011vehicles} para un Mini Cooper ($H_c = 1{,}417$ m, $\rho_c = 1\,009$ kg/m³), con parámetros distintos según el grado de sumersión: parcial ($H < H_c$: $\alpha = 1{,}225$, $\beta = -0{,}708$) y total ($H \geq H_c$: $\alpha = 0{,}932$, $\beta = 0{,}121$). La curva naranja corresponde a $0{,}5 \times U_{c,v}$ y la roja a $U_{c,v}$.
...
Q10c-Xia. Inestabilidad de vehículos (Xia et al., 2022): mapa de riesgo de arrastre para un turismo tipo Mini Cooper en tres niveles. El cambio de régimen al alcanzar la altura del vehículo ($H_c$) produce un salto en la curva de velocidad crítica.
