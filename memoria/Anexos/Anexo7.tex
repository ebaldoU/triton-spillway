\chapter{Interoperabilidad con sistemas GIS}\label{anexo-g.-interoperabilidad-gis}
...
El proyecto \texttt{.qgz} referencia el COG mediante ruta relativa, de modo que el paquete puede entregarse como una carpeta autocontenida sin que se rompan los enlaces: quien lo recibe solo tiene que abrir el proyecto. La Figura~\ref{fig:qgis-calado} muestra la capa de calado abierta en QGIS con el estilo aplicado, y la Figura~\ref{fig:qgis-cog} las propiedades del raster, donde se aprecian las pirámides (\textit{overviews}) que lo identifican como COG.
