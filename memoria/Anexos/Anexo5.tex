...
\texttt{TRITON\_GTIFF\_DIR} & Raíz de los GeoTIFF fuente & Un subdirectorio por escenario nombrado con el alias definido en \texttt{config.py} (p.~ej. \texttt{datos1/} si ese es el alias elegido), con 80 ficheros GeoTIFF cada uno (4 variables $\times$ 20 pasos). Solo necesaria para el ETL. \\
