...
Los tres parámetros que controlan el comportamiento del ETL se definen como constantes al inicio del script y se describen en la Tabla~\ref{tab:etl-params}.
...
Tras completar la escritura de los 20 fragmentos, el script almacena en el propio array TileDB los metadatos geoespaciales necesarios para interpretar los datos y para la interoperabilidad con herramientas SIG, recogidos en la Tabla~\ref{tab:etl-metadata}.
