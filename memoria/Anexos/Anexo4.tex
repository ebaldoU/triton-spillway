...
\item \textbf{Filtro de compresión:} \texttt{tiledb.ByteShuffleFilter()} seguido de \texttt{tiledb.ZstdFilter(level=9)}, elegidos tras el benchmark del Anexo B (reducción adicional del 8,9\,\% frente a ZSTD-1 sin penalización en lectura).
\end{itemize}
...
Estos metadatos permiten al motor de consultas reconstruir el georeferenciado sin necesidad de conservar los GeoTIFF originales.
...
\begin{itemize}
\item Los 80 ficheros GeoTIFF del escenario deben estar disponibles en el directorio fuente (por defecto \texttt{/home/ebald/TFG/\{dataset\}}).
...
/home/ebald/venvs/tiledb_env/bin/python \
    geotiff_to_tiledb_sparse.py --dataset datos1
\end{verbatim}

Para ejecutar en el servidor de producción (variable de entorno necesaria):
...
\begin{verbatim}
Dataset: datos1
  GTIFF_DIR:  /home/ebald/TFG/datos1
